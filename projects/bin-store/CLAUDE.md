...
- OpenSCAD model: `model/` (`parameters.scad` is dimensional source of truth)
- Cut extraction mapping: `extraction.py`
- Snapshots: `data/cut_list.json`, `data/shopping_list.json`, `data/substitution_candidates.json`
